        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(URL::to('/update-product/'.$product_edit->id)); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="product_name" value="<?php echo e($product_edit->product_name); ?>" 
...
unset($__errorArgs, $__bag); ?>" name="product_code" value="<?php echo e($product_edit->product_code); ?>" 
...
unset($__errorArgs, $__bag); ?>" name="product_nsx" value="<?php echo e($product_edit->product_nsx); ?>" 
...
unset($__errorArgs, $__bag); ?>" name="product_price"  value="<?php echo e($product_edit->product_price); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="product_image" type="file"  name="product_image" autocomplete="new-product_image" value="<?php echo e($product_edit->product_image); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <input id="product_type" type="text" class="form-control" name="product_type" value="<?php echo e($product_edit->product_type); ?>" required autocomplete="new-password">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/quanlystore/resources/views/product/edit_product.blade.php ENDPATH**/ ?>